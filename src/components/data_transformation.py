...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            numerical_columns = ['age', 'height_cm','potential', 
                'value_eur', 'preferred_foot', 'weak_foot', 'skill_moves', 'attacking_heading_accuracy', 
                'skill_dribbling', 'skill_ball_control', 'movement_reactions', 'power_jumping', 'power_strength', 
                'mentality_vision', 'pace_median'
            ]
